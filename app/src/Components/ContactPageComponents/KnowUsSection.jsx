...
export const KnowUsSection = () => {
    ...
    const telNumber = "+1 234 567 8910";
    ...
    mt-7 md:mt-20'>
        ...
        ref={contentRef} className='w-full xl:w-[35%] md:w-[40%] flex md:gap-0 gap-10 xl:gap-4 items-center mt-[30px] md:mt-0'>
            ...
            <div className="md:w-[70%] w-[85%]">
                ...
                <p className='font-semibold text-[#B50404] text-[14px] md:text-base tracking-[2px] uppercase'>India</p>
                <p className='font-normal text-xs md:text-xl leading-3 md:leading-6 text-[#737373] mt-3'>Villa No.3, Lotus Serene Villas,Near Autonagar, Renigunta Road, Tirupati </p>
        ...
        className='w-full xl:w-[25%] order-2 flex justify-between md:flex-col md:justify-normal items-start mt-[10px] md:mt-0'>
            ...
            <div className='flex gap-2 items-center justify-center mb-3'>
                ...
                <a href={`tel:${telNumber}`}><p className='font-normal text-[10px] md:text-xl'>{telNumber}</p></a>
            ...
            <div className='flex gap-2 items-center '>
                ...
                <a href={`https:${mail}`}><p className='font-normal text-[10px] md:text-xl'>{mail}</p></a>

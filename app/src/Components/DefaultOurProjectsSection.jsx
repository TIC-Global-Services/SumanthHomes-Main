export const DefaultOurProjects = ({bgImage, miniHeader , mainHeader, description }) => {
  return (
    <div className='xl:mb-10'>
        ...
        <div className='justify-self-center xl:h-[600px] xl:w-full md:h-[390px] md:w-[640px] relative' style={{
            backgroundImage:`url(${bgImage})`,
            backgroundSize:'cover',
            backgroundRepeat:'no-repeat'
        }}>
            
            <div className='bg-[#B50404] flex justify-center items-center xl:w-10 xl:h-52 md:w-10 md:h-32 relative'>

                <h4 className='font-manrope font-bold rotate-[270deg] xl:text-xs md:text-xs text-white flex-shrink-0'>RECENT PROJECTS</h4>

            </div>

            <div className='xl:right-[30rem] md:right-[20rem] bottom-0 absolute'>

                <button className='bg-[#191919] box-border xl:w-16 xl:h-16 md:w-10 md:h-10 flex justify-center items-center xl:mb-1 md:mb-1'><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M15.0008 0.625C15.0008 0.45924 14.9349 0.300269 14.8177 0.183058C14.7005 0.0658481 14.5415 0 14.3758 0H6.87579C6.71003 0 6.55106 0.0658481 6.43385 0.183058C6.31664 0.300269 6.25079 0.45924 6.25079 0.625C6.25079 0.79076 6.31664 0.949731 6.43385 1.06694C6.55106 1.18415 6.71003 1.25 6.87579 1.25H12.867L0.183289 13.9325C0.125179 13.9906 0.0790843 14.0596 0.0476354 14.1355C0.0161866 14.2114 0 14.2928 0 14.375C0 14.4572 0.0161866 14.5386 0.0476354 14.6145C0.0790843 14.6904 0.125179 14.7594 0.183289 14.8175C0.241399 14.8756 0.310386 14.9217 0.38631 14.9532C0.462234 14.9846 0.54361 15.0008 0.625789 15.0008C0.707969 15.0008 0.789344 14.9846 0.865269 14.9532C0.941193 14.9217 1.01018 14.8756 1.06829 14.8175L13.7508 2.13375V8.125C13.7508 8.29076 13.8166 8.44973 13.9338 8.56694C14.0511 8.68415 14.21 8.75 14.3758 8.75C14.5415 8.75 14.7005 8.68415 14.8177 8.56694C14.9349 8.44973 15.0008 8.29076 15.0008 8.125V0.625Z" fill="white"/></svg></button>
                <button className='bg-[#191919] box-border xl:w-16 xl:h-16 md:w-10 md:h-10 flex justify-center items-center'><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M2.5 16.8748C2.5 17.0406 2.56585 17.1995 2.68306 17.3168C2.80027 17.434 2.95924 17.4998 3.125 17.4998H10.625C10.7908 17.4998 10.9497 17.434 11.0669 17.3168C11.1842 17.1995 11.25 17.0406 11.25 16.8748C11.25 16.7091 11.1842 16.5501 11.0669 16.4329C10.9497 16.3157 10.7908 16.2498 10.625 16.2498H4.63375L17.3175 3.56731C17.4349 3.44995 17.5008 3.29078 17.5008 3.12481C17.5008 2.95884 17.4349 2.79967 17.3175 2.68231C17.2001 2.56495 17.041 2.49902 16.875 2.49902C16.709 2.49902 16.5499 2.56495 16.4325 2.68231L3.75 15.3661V9.37481C3.75 9.20905 3.68415 9.05008 3.56694 8.93287C3.44973 8.81566 3.29076 8.74981 3.125 8.74981C2.95924 8.74981 2.80027 8.81566 2.68306 8.93287C2.56585 9.05008 2.5 9.20905 2.5 9.37481V16.8748Z" fill="white"/></svg></button>

            </div>

            <div className='bg-white xl:px-9 xl:py-12 md:py-6 md:px-6 bottom-0 xl:left-[52rem] md:left-[20rem]  absolute'>

                <div className='mb-4'> 

                    <h4 className='font-jakarta font-semibold xl:text-sm md:text-xs'>{miniHeader}</h4>
                    <h2 className='font-manrope font-semibold xl:text-5xl md:text-2xl'>{mainHeader}</h2>

                </div>

                <div >

                    <p className='mb-4 text-[#737373] font-jakarta font-normal md:text-xs'>{description}</p>


                    <div className='flex items-center gap-2'>
                        
                        <h4 className='font-jakarta xl:text-sm md:text-xs font-bold'>EXPLORE PROJECT</h4>

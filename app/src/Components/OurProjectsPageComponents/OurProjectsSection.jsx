...
export const OurProjectsSection = () => {
  return (
    <div>
        ...
        <div className="mb-10">
            <p className='text-center xl:mb-4 md:mb-1 font-jakarta font-semibold uppercase tracking-[0.2rem] [word-spacing:3px] text-[rgb(181,4,4)] text-xs'>DREAMS IN CONCRETE</p>
            <h2 className='text-center font-manrope font-semibold text-black xl:text-4xl xl:mb-5 md:text-2xl md:mb-5 '>Ongoing Projects</h2>
        </div>

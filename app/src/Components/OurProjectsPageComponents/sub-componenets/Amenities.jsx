        ...
        <div className='flex gap-2 flex-wrap md:flex-nowrap'>
          ...
          <div className=' flex flex-col justify-center items-center flex-grow border-r-2 border-[#E4E4E4] '>
            <div className="flex w-[50%] aspect-square rounded-full bg-gradient-to-br from-[#B50404]/15 from-0% via-[#B50404]/15 via-[50%] to-transparent to-50%">
              <svg className='mx-auto my-auto' width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className='text-sm font-urbanist font-semibold tracking-wide'>Clubhouse</p>
          </div>
          ...
          <div className=' flex flex-col justify-center items-center flex-grow border-r-2 border-[#E4E4E4]'>
            <div className="flex w-[50%] aspect-square rounded-full bg-gradient-to-tl from-[#B50404]/15 from-0% via-[#B50404]/15 via-[50%] to-transparent to-50%">
              <svg className="mx-auto my-auto" width="37" height="34" viewBox="0 0 37 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className='text-sm font-urbanist font-semibold tracking-wide'>Swimming Pool</p>
          </div>
          ...
          <div className=' flex flex-col justify-center items-center flex-grow border-r-2 border-[#E4E4E4]'>
            ...
            <p className='text-sm font-urbanist font-semibold tracking-wide'>Play Area</p>
          </div>
          ...
          <div className=' flex flex-col justify-center items-center flex-grow border-r-2 border-[#E4E4E4]'>
            ...
            <p className='text-sm font-urbanist font-semibold tracking-wide'>Walking Track</p>
          </div>
          ...
          <div className=' flex flex-col justify-center items-center flex-grow border-r-2 border-[#E4E4E4]'>
            ...
            <p className='text-sm font-urbanist font-semibold tracking-wide'>24/7 Security</p>
          </div>
          ...
          <div className=' flex flex-col justify-center items-center flex-grow border-r-2 border-[#E4E4E4]'>
            ...
            <p className='text-sm font-urbanist font-semibold tracking-wide'>Indoor Games</p>
          </div>

export const CardButtons = ({prev, next}) => {

    // Takes in two functions prev & next
    // prev represents the function/callback that gets triggered when left button is clicked
    // next represents the function/callback that gets triggered when right button is clicked
